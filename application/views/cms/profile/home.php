<!-- Main content -->
<?php 
echo form_open_multipart("cms/dashboard/profile-save", ["id" => "form-info"]);
?>
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly type="number" id="inputSalary" class="form-control" value="<?= isset($staff) ? $staff->salary : "" ?>">
                    </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                    <input type="submit" value="Save" class="btn btn-primary">
                    <a href="<?= site_url("cms/dashboard") ?>" class="btn btn-secondary">Cancel</a>
                </div>
            </div>
            <!-- /.card -->
        </div>
...
$("#form-info").submit(function(e) {
    e.preventDefault();
    $.post("<?= site_url("cms/dashboard/profile-check-form") ?>", $(this).serialize(), function(response) {
        if (response == "ok") {
