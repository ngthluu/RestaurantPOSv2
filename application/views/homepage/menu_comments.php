<div class="comments t-white">
    <div class="row">
        ...
        <?= form_open("menu/submit-feedback", ["id" => "form-info"]); ?>
            <h3>Your feedback</h3>
            <select mame="rating" class="form-control">
            ...
            <textarea class="form-control mt-3" name="comment" rows="5" placeholder="Your feedback here"></textarea>
